            ...
            <div class="gird">
                ...
                <div class="main-deal">
                    ...
                    <div class="main-deal_product">
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/213031/TimerThumb/iphone-12-(16).jpg" alt="">
                            <h5 class="main-deal_product_p">iPhone 12 64GB</h5>
                            <div class="main-deal_product_cost">
                                <h5>16.490.000sup>đ</sup></h5>
                                <p>-35%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/228742/iphone-12-mini-do-600x600.jpeg" alt="">
                            <h5 class="main-deal_product_p">iPhone 12 mini 256GB</h5>
                            <div class="main-deal_product_cost">
                                <h5>15.990.000<sup>đ</sup></h5>
                                <p>-25%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>5</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/60/269508/op-lung-magsafe-iphone-13-pro-max-nhua-deo-apple-mm2u3-290722-011202-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Ốp lưng MagSafe iPhone 13 Pro Max Nhựa dẻo Apple MM2U3</h5>
                            <div class="main-deal_product_cost">
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/244141/iphone-se-white-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p"> iPhone SE 64GB (2022)</h5>
                            <div class="main-deal_product_cost">
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/230412/iphone-se-2020-trang-600x600-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p"> iPhone SE 128GB (2020) (Hộp mới)</h5>
                            <div class="main-deal_product_cost">
                                <h5>9.290.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
                ...
                <div class="main-deal">
                    <div class="main-deal_product1">
                        <?php
                        // $sql_product = "SELECT * FROM san_pham where ma_san_pham BETWEEN 'SP001' AND 'SP010'";
                    ...
                    <!-- <div class="main-deal_product1">
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/272668/TimerThumb/xiaomi-redmi-note-11s-5g-(2).jpg" alt="">
                            <h5 class="main-deal_product_p">Xiaomi Redmi Note 11S 5G</h5>
                            <div class="main-deal_product_cost">
                                <h5>6.490.000<sup>đ</sup></h5>
                                <p>-35%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/262650/TimerThumb/samsung-galaxy-a23-(4).jpg" alt="">
                            <h5 class="main-deal_product_p">Samsung Galaxy A23 4GB</h5>
                            <div class="main-deal_product_cost">
                                <h5>5.190.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>5</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/249720/TimerThumb/vivo-y15s-2021-(4).jpg" alt="">
                            <h5 class="main-deal_product_p"> Vivo Y15s</h5>
                            <div class="main-deal_product_cost">
                                <h5>3.290.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>5</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/249944/oppo-a55-4g-thumb-new-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">OPPO A55</h5>
                            <div class="main-deal_product_cost">
                                <h5>4.290.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
                    ...
                    <!-- <div class="main-deal_product1">
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/250625/samsung-galaxy-z-fold4-kem-256gb-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Samsung Galaxy Z Fold4 5G</h5>
                            <div class="main-deal_product_cost">
                                <h5>36.490.000sup>đ</sup></h5>
                                <p>-35%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/226935/TimerThumb/samsung-galaxy-z-fold-3-(10).jpg" alt="">
                            <h5 class="main-deal_product_p"> Samsung Galaxy Z Fold3 5G 256GB</h5>
                            <div class="main-deal_product_cost">
                                <h5>31.990.000<sup>đ</sup></h5>
                                <p>-25%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>5</p>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/250622/TimerThumb/oppo-find-x5-pro.jpg" alt="">
                            <h5 class="main-deal_product_p">OPPO Find X5 Pro 5G</h5>
                            <div class="main-deal_product_cost">
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/242439/Galaxy-S22-Plus-White-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Samsung Galaxy S22+ 5G 128GB</h5>
                            <div class="main-deal_product_cost">
                                <h5>21.990.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
                    ...
                    <!-- <div class="main-deal_product1">
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/258047/samsung-galaxy-z-flip4-5g-128gb-thumb-tim-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Samsung Galaxy Z Flip4 5G</h5>
                            <div class="main-deal_product_cost">
                                <h5>21.990.000<sup>đ</sup></h5>
                                <p>-25%</p>
                            </div>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/253138/vivo-x80-xanh-thumb-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Vivo X80 </h5>
                            <div class="main-deal_product_cost">
                                <h5>18.990.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/231110/Galaxy-S22-Black-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Samsung Galaxy S22 5G 128GB </h5>
                            <div class="main-deal_product_cost">
                        ...
                        <div class="main-deal_product_1">
                            <p class="main-deal_product-header">Trả góp 0%</p>
                            <img class="main-deal_product-img" src="https://cdn.tgdd.vn/Products/Images/42/245607/Vivo-V23e-1-2-600x600.jpg" alt="">
                            <h5 class="main-deal_product_p">Vivo V23e</h5>
                            <div class="main-deal_product_cost">
                                <h5>7.290.000<sup>đ</sup></h5>
                                <p>-15%</p>
                            </div>
                            <div class="main-deal_product_start">
                                <p>4</p>
